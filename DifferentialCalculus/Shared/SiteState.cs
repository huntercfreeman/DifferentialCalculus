...
namespace DifferentialCalculus.Shared
{
    public class SiteState
    {
        ...
        public SiteState()
        {
            ...
            CurrentProblem = new Problem { Number = 0, Answer = "<h1>Differential Calculus is being completed the other maths have not been started and just have placeholder questions</h1><h1>Select a Section and Problem from the top left menu.</br> This site contains all the answers to:</br>ISBN: 0495557420</br>ISBN-13: 9780495557425</br>Authors:James Stewart</br></h1>", Images = new List<string> { "content/9688171_1375654336_Width288.jpg" } };
        }
